...
<?php 
$suid=$_GET['sid'];
$query=mysqli_query($con,"select id,subcategoryName from subcategory where id = $suid");
while($result=mysqli_fetch_array($query))
{ ?>

                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder"><?php echo $result['subcategoryName'];?></h1>
...
products.productName,products.productPriceBeforeDiscount,
products.productPrice from products where subCategory='$suid'");
