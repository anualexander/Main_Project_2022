        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="admin/productimages/<?php echo htmlentities($row['productImage1']);?>" alt="<?php echo htmlentities($row['productName']);?>" width="400" height="400" style="border:solid 1px #000;"/>
<img src="admin/productimages/<?php echo htmlentities($row['productImage2']);?>" height="300" width="250" style="border:solid 1px #000; margin-top: 10px;">
<img src="admin/productimages/<?php echo htmlentities($row['productImage3']);?>" height="300" width="250" style="border:solid 1px #000; margin-top: 10px;">
